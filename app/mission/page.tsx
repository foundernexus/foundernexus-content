    ...
    <article>
      ...
      <section className="mx-auto max-w-3xl px-4 pt-28 pb-20">
        ...
        <p className="mt-6 text-lg text-muted max-w-xl leading-relaxed">
          ...
          have lived your decision in the room at the moment you have to make it.
        </p>
      </section>
        ...
        <div className="mx-auto max-w-3xl px-4 py-20">
          ...
          <div className="mt-6 space-y-5 text-base leading-relaxed text-fg/90">
            ...
            <p>
              ...
              not lived the experience, and being a founder has complexities
              you only understand by carrying them yourself.
            </p>
            <p>
        ...
        <div className="mt-8 space-y-10">
          ...
          <div>
            ...
            <p className="mt-2 text-muted leading-relaxed">
              ...
              real-time decision support changes outcomes in a way no amount
              of content, capital, or encouragement can.
            </p>
          </div>
          <div>
            <h3 className="text-lg font-semibold">
        ...
        <div className="mx-auto max-w-3xl px-4 py-20">
          ...
          <div className="mt-6 space-y-5 text-base leading-relaxed text-fg/90">
            ...
            <p>
              ...
              founders who go it alone. FounderNexus is how I put that pattern
              to work for you.
            </p>
      ...
      <section className="mx-auto max-w-3xl px-4 py-20 text-center">
        ...
        <p className="mt-4 text-muted max-w-xl mx-auto leading-relaxed">
          ...
          Apply, and if you meet our criteria you will attend your first
